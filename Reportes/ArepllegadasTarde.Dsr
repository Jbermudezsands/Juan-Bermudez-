VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ArepllegadasTarde 
   Caption         =   "ArepllegadasTarde"
   ClientHeight    =   10980
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   20280
   ...
   _ExtentX        =   35772
   _ExtentY        =   19368
   SectionData     =   "ArepllegadasTarde.dsx":0000
End
Attribute VB_Name = "ArepLlegadasTarde"
...
Private Sub Detail_Format()
   ...
   If TieneJustificacion(Me.Field16.Text, Me.FldFechaEntradaInicio.Text, Me.FldFechaEntradaFin.Text) = True Then
    If FrmReportesReloj.ChkLink.Value = 0 Then
      Me.FldJustificacion.Hyperlink = CodigoEmpleado
    End If
