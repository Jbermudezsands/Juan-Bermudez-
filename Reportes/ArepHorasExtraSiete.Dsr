VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ArepHorasExtraSiete 
   Caption         =   "Reporte de Horas Extra Siete"
   ClientHeight    =   10980
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   20280
   ...
   _ExtentX        =   35772
   _ExtentY        =   19368
   SectionData     =   "ArepHorasExtraSiete.dsx":0000
End
Attribute VB_Name = "ArepHorasExtraSiete"
...
Private Sub Detail_Format()
 ...
 End If
  ...
  Me.FldTotal.Text = Mid(TotalHoras, 1, Len(TotalHoras) - 3)
